        ...
        private static void ParseInput(string input)
        {
            ...
            else if(input.Contains("attack"))
            {
                ...
                else
                {
                    ...
                    {
                        // Select the first weapon in the player's inventory(or 'null', if they do not have any weapons)
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        InventoryItem itemToSell =
                            _player.Inventory.SingleOrDefault(x => x.Details.Name.ToLower() == itemName && x.Quantity > 0 && x.Price != World.UNSELLABLE_ITEM_PRICE);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("You recieve {0} gold for your {1}", itemToSell.Price, itemToSell.Details.Name);
                        }
                    }
                }
            }
