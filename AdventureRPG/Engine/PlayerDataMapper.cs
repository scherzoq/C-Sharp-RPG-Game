...
namespace Engine
{
    public static class PlayerDataMapper
    {
        private static readonly string _connectionString =
            @"Data Source=(local)\SQLEXPRESS;Initial Catalog=AdventureRPG;Integrated Security=True;MultipleActiveResultSets=true;";
        ...
        public static Player CreateFromDatabase()
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    // our database. The SqlCommand object is where we create our SQL statement.
                    ...
                    // Read the rows/records from the Inventory table, and them to the player
        ...
        public static void SaveToDatabase(Player player)
        {
            try
            {
                using(SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using(SqlCommand existingRowCountCommand = connection.CreateCommand())
                    {
                        ...
                        else
                        {
                            ...
                            using(SqlCommand updateSavedGame = connection.CreateCommand())
                            {
                                ...
                                // Pass the values from the player object, to the SQL query, using parameters
                                // Using parameters helps make your progress more secure.
                    ...
                    // This is easier than trying to to add/delete/update each individual rows
